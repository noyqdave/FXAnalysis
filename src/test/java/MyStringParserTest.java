...
class MyStringParserTest {
    ...
    void testEmptyLine() {
        String testString = "";
        String [] actualStrings = MyStringParser.parseStringIntoArray(testString,1);
    ...
    void testLineOfValues() {
        ...
        Assertions.assertArrayEquals(expectedStrings, MyStringParser.parseStringIntoArray(testString,11));
    }
}